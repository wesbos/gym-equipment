...
- Final main integration: 8a53045 (reset/swap and pull-up orientation retained).
- `npm test`: 144 passed, 0 failed/skipped (11.37 s).
...
- `GYM_LOGO_CDP_URL=<isolated Chrome endpoint> npm run test:logos:browser -- --reporter=line`:
  1 passed, 8.5 s. Covers text, SVG, PNG, JPEG, threshold/contrast, scripts rejected,
