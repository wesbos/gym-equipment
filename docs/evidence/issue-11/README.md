...
- Final main integration: b772ccd (vendor attachments, multiselect, proposals, 3MF and prior integrations retained).
- `npm test`: 247 passed, 0 failed/skipped (73.11 s).
