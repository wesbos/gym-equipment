...
import {
  ...
  REP_GENESIS_JACK, RITFIT_DEADLIFT_JACK, ROGUE_ECHO_SLAM_BALL, ROGUE_MEDICINE_BALL, ROGUE_OLY_PLATFORM, TITAN_SQUAT_WEDGE, TRIGGERPOINT_GRID, TSC_STALL_MAT, U4C_CALF_CURVE, BEYOND_POWER_TRAVEL_PLATFORM,
...
import { buildTravelPlatform } from './floor-accessories-voltra.ts';
...
export const definitions: PartDefinition[] = [
  ...
  floorDefinition(BEYOND_POWER_TRAVEL_PLATFORM, buildTravelPlatform),
];
