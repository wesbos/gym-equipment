...
import { ASSAULT_BIKE_CLASSIC, BOS_BLITZ_AIR_BIKE, CONCEPT2_MODEL_C, CONCEPT2_MODEL_D, CONCEPT2_ROWERG, REP_STRIVE_AIR_BIKE, ROGUE_ECHO_BIKE, CONCEPT2_SKIERG, ROGUE_ECHO_SKI, CONCEPT2_BIKEERG, ROGUE_ECHO_ROWER, SCHWINN_AIRDYNE_AD6, SCHWINN_AIRDYNE_AD7 } from '../floor-parts/ergs.ts';
import { buildAirBike } from './ergs-bikes.ts';
import { airdyneAd6, airdyneAd7, assaultClassic, blitz, echoBike, strive } from './ergs-bike-specs.ts';
