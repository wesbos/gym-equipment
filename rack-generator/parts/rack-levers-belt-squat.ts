...
import { OAK_CLUB_CAMPBELL } from '../rack-parts/oak-club-campbell.ts';
import { buildCampbell } from './oak-club-campbell.ts';
...
export const definitions: PartDefinition[] = [
  rackDefinition(OAK_CLUB_CAMPBELL, buildCampbell),
