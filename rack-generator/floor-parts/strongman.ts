...
import { ABMAT_LOG_CUSHIONS, BARTOS_CIRCUS_DB, CERBERUS_DINNIE, ROGUE_DINNIE_RINGS, ROGUE_FARMERS, ROGUE_Y1, ROGUE_Y2, TITAN_CIRCUS_DB, TITAN_FARMERS, TITAN_LOG, TITAN_UPRIGHT_FARMERS, TITAN_YOKE, PITBULL_12_LOG } from './strongman-frames.ts';
export const PARTS = [
  ...
  TITAN_FARMERS, ROGUE_DINNIE_RINGS, TITAN_HUSAFELL_STONE, ROGUE_Y1, CERBERUS_HUSAFELL_SANDBAG, CERBERUS_SANDSTONE, BARTOS_STONE_OF_STEEL, PITBULL_12_LOG,
