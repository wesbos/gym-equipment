...
export interface RackDoc { appearance?: Appearance; version: 1; rack: RackDimensions; removed: string[]; structure: Record<string, StructureVariant>; accessories: Accessory[]; nextId: number }
