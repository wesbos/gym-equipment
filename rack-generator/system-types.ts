...
export const SYSTEM_NAMES: Record<SystemPartId, string> = {
  "cable-kraken": "Bells of Steel Kraken",
  "cable-ares2": "REP ARES 2.0",
  "cable-athena": "REP Athena",
  "cable-ares1": "REP ARES 1.0 (historical)",
  "smith-rep": "REP Smith",
};
...
export const SYSTEM_NOTE =
  "Reconstructed from manufacturer manuals. Published envelope dimensions; bracket contours, pulley centers, routing lengths, first-hole datum and fabrication tolerances are estimated. Static visualization, not certified physical fit.";
