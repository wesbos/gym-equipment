...
| `rogue-sml-1` SML-1 70″ squat stand (33) | 72.25″ ★ | 3×3 posts, 2×3 base | 5/8″ / Westside | 48 × 49 footprint, 72.25″ | two 48″ feet + rear floor bar, triangle plates |
...
- **Feet:** 2x3 laid flat (3″ wide × 2″ tall) for Rogue ML stands, HR-2, RML-390F, X-3 FF and Apollo; 2x2 for T-2 and PR-1100. Post position on 48″ Rogue feet is 16″ from the front (SML-1/2, S-2, HR-2 front posts), from side photos; HR-2 rear posts sit 17″ behind (published crossmember) leaving 9″ behind. RML-390F and X-3 FF 6″ each end (48″ foot − 36″ outside depth). T-2 10″, PR-1100 10.25″, Apollo 13″ each end (footprint − outside depth, split evenly). Gussets: 9″ × 4″ (Rogue ML), 10″ × 5″ (SM-1), 14″ × 5″ (Titan FF), 1/4″ plate.
