...
- Estimated: pad 18" × 135 × 140 mm (photo-scaled from the drawing), arms 127 mm wide × 118 mm deep with 8" between them, arm length 282 mm below the shaft, 8° forward tilt, bend radius 30 mm. The camber plane is tilted 20° forward, with a 5" vertical drop. Red end caps from the gallery.
...
- Estimated: neck pad 18" × 150 × 170 mm with "SS YOKE" on top; round arm pads 110 mm across, 290 mm long, 20° forward; sleeves 49.5 mm × 14.5" (photo-scaled; EliteFTS notes spring collars do not fit); welded 66 mm collar ring; four raised grip rings per handle.
...
- Estimated: 32 mm shaft (photo ratio to the 2" sleeve), pad 432 × 125 × 132 mm with a flat front face carrying the white REP mark, 25° camber tilt, bend radius 36 mm.
...
- Estimated: the absolute camber angles (−60° to +90° from straight down; the studio front view shows position 0° with slot 4); slot radii 100/130/160/190 mm (slot 4 matches the ~7.5" drop in the front view); bracket plate 16 mm thick and 62/48 mm end radii; indexing hub 140 mm across; pad and arm sizes; the 60° bend on the short handles.
...
- Estimated: 48" between cambers (photo-scaled from the spec graphic), 3.5" drop, arm size and length, handle-accessory lengths and bends, and a bronze bearing seal ring by each collar.
...
- Params: finish.
- Estimated: a 3.25" camber over a 700 mm half-width. The bend starts just inside the collars, from rack and floor photos. The real bend is "multiple radius", and we approximate it with a raised-cosine bow. Knurl is segmented into 80 mm bands with 12 mm smooth rings, from the floor photo.
...
- Estimated: 80" overall and a 39.5" frame (photo-scaled from the side view; the frame length matches the minimum rackable space); frame 280 mm deep; 25 × 38 mm rails; 2" camber (owner review) over a 300 mm flat centre with 50 mm slopes; 32 mm grips slanted 18°; 32 mm shaft stubs; 50 mm sleeves; white EliteFTS mark on the back rail.
