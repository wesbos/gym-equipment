...
for(const file of ['front','storage']) {
 const b=fs.readFileSync(new URL(`./${file}.glb`,import.meta.url)); const j=JSON.parse(b.toString('utf8',20,20+b.readUInt32LE(12)));
