...
export function RackPresets({store}:{store:BuilderStore}) {
  ...
  return <details className="rack-presets"><summary>Rack starting points</summary>
    ...
    <label>REP reconstruction<select aria-label="REP reconstruction" value={choice} onChange={e=>setChoice(e.target.value)} style={{width:'100%'}}>
    ...
    <button type="button" onClick={()=>apply(choice)}>Apply REP reconstruction</button>
